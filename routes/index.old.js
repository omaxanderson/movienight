...
// 	connection.connect();
// 	connection.query("SELECT DATE_FORMAT(MAX(end_date), '%Y-%m-%d %H:%I:%s') AS endDate FROM movie_night", 
// 		(err, rows, fields) => {
// 			if (err) {
// 				console.log(err);
...
// 			console.log(rows);
// 			connection.query("SELECT * FROM movie_night WHERE movie_night_id = " + rows.insertId,
// 				(err2, rows2, fields2) => {
// 					console.log(rows2);
// 					console.log(err2);
// 					console.log(fields2);
...
// 						status: 200,
// 						data: {
// 							insertId: rows2[0]['movie_night_id'],
